...
class TestSoftMaxWithLoss(unittest.TestCase):
    def setUp(self):
        self.soft_max_with_loss = SoftMaxWithLoss()
        self.x = np.array([
    ...
    def test_forward(self):
        self.assertEqual(0.5879459780961449, self.soft_max_with_loss.forward(self.x, self.t))

    def test_backward(self):
        self.soft_max_with_loss.forward(self.x, self.t)
        ...
        ]), self.soft_max_with_loss.backward())
